---
layout: post
title: RNA-Seq absolute quantification
desc: A subset of my collection of R, Python and some Bash code I used to analyze and quantify RNA-Seq, ribosome profiling and Mass Spec proteomics data.
proj-url: https://github.com/igor25/rnaseq
proj-lang: R, Python, Bash
proj-num: 03
---
